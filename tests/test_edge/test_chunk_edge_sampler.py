...
class TestChunkEdgeSampler(unittest.TestCase):
    def test_without_overlap_without_remainder_2d(self):
        ...
        self._test_sampler(image, spatial_size, patch_size, chunk_size)
    ...
    def test_channel_first(self):
        ...
        self._test_sampler(image, spatial_size, patch_size, chunk_size, spatial_first=spatial_first)
    ...
    def _test_sampler(self, image, spatial_size, patch_size, chunk_size, patch_overlap=None, spatial_first=True):
        ...
        sampler = GridSampler(image=image, spatial_size=spatial_size, patch_size=patch_size, chunk_size=chunk_size, patch_overlap=patch_overlap, spatial_first=spatial_first, mode="sample_edge")
        ...
        # Test without image
        result = np.zeros_like(image)
        sampler = GridSampler(spatial_size=spatial_size, patch_size=patch_size, chunk_size=chunk_size, patch_overlap=patch_overlap, spatial_first=spatial_first, mode="sample_edge")
