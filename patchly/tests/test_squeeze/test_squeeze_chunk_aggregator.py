...
class TestSqueezeChunkAggregator(unittest.TestCase):
    ...
    def _test_aggregator(self, image, spatial_size, patch_size, chunk_size, step_size=None, spatial_first_sampler=True, spatial_first_aggregator=True, output=None, weights='avg', multiply_elements_by_two=False, softmax_dim=None):
        ...
        sampler = GridSampler(image=copy.deepcopy(image), spatial_size=spatial_size, patch_size=patch_size, step_size=step_size, chunk_size=chunk_size, spatial_first=spatial_first_sampler, mode=SamplingMode.SAMPLE_SQUEEZE)
