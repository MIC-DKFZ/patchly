...
class TestBasicGridSampler(unittest.TestCase):
    ...
    def test_patch_size_larger_than_image_size(self):
        ...
        self.assertRaises(RuntimeError, BasicGridSampler, image=image, image_size=image_size, patch_size=patch_size)
    ...
    def test_overlap_size_larger_than_patch_size(self):
        ...
        self.assertRaises(RuntimeError, BasicGridSampler, image=image, image_size=image_size, patch_size=patch_size, patch_overlap=patch_overlap)
