...
class TestAdaptiveChunkAggregator(unittest.TestCase):
    ...
    def test_gaussian_weights(self):
        ...
        self.assertRaises(RuntimeError, self._test_aggregator, image=image, spatial_size=spatial_size, patch_size=patch_size, chunk_size=chunk_size, patch_offset=patch_offset, weights='gaussian', multiply_elements_by_two=True)
