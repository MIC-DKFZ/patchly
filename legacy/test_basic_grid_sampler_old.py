...
class TestBasicGridSampler(unittest.TestCase):
    ...
    def test_channel_first(self):
        ...
        for patch, patch_indices in sampler:
            ...
            np.testing.assert_array_equal(patch, image[slicer(image, slices)], err_msg="image shape: {}, patch shape: {}, patch indices: {}".format(image.shape, patch.shape, patch_indices))
...
def suite(repetitions=10):
    print("Test2")
    suite = unittest.TestSuite()
    for _ in range(repetitions):
        suite.addTest(TestBasicGridSampler('test_without_overlap_without_remainder_2d'))
        suite.addTest(TestBasicGridSampler('test_without_overlap_with_remainder_2d'))
        suite.addTest(TestBasicGridSampler('test_with_overlap_without_remainder_2d'))
        suite.addTest(TestBasicGridSampler('test_with_overlap_with_remainder_2d'))
        suite.addTest(TestBasicGridSampler('test_without_overlap_without_remainder_3d'))
        suite.addTest(TestBasicGridSampler('test_without_overlap_with_remainder_3d'))
        suite.addTest(TestBasicGridSampler('test_with_overlap_without_remainder_3d'))
        suite.addTest(TestBasicGridSampler('test_with_overlap_with_remainder_3d'))
        suite.addTest(TestBasicGridSampler('test_without_overlap_without_remainder_Nd'))
        suite.addTest(TestBasicGridSampler('test_without_overlap_with_remainder_Nd'))
        suite.addTest(TestBasicGridSampler('test_with_overlap_without_remainder_Nd'))
        suite.addTest(TestBasicGridSampler('test_with_overlap_with_remainder_Nd'))
        suite.addTest(TestBasicGridSampler('test_without_channel'))
        suite.addTest(TestBasicGridSampler('test_channel_first'))
        suite.addTest(TestBasicGridSampler('test_channel_last'))
        suite.addTest(TestBasicGridSampler('test_batch_and_channel_dim'))
        suite.addTest(TestBasicGridSampler('test_multiple_non_spatial_dims'))
        suite.addTest(TestBasicGridSampler('test_numpy'))
        suite.addTest(TestBasicGridSampler('test_zarr'))
        suite.addTest(TestBasicGridSampler('test_without_patch_size'))
        suite.addTest(TestBasicGridSampler('test_patch_size_larger_than_image_size'))
        suite.addTest(TestBasicGridSampler('test_overlap_size_larger_than_patch_size'))
    return suite
