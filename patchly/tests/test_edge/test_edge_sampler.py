...
class TestEdgeSampler(unittest.TestCase):
    ...
    def test_offset_size_larger_than_patch_size(self):
        ...
        self.assertRaises(RuntimeError, GridSampler, image=image, spatial_size=spatial_size, patch_size=patch_size, step_size=step_size, mode=SamplingMode.SAMPLE_EDGE)
    ...
    def _test_sampler(self, image, spatial_size, patch_size, step_size=None, spatial_first=True):
        ...
        sampler = GridSampler(image=image, spatial_size=spatial_size, patch_size=patch_size, step_size=step_size, spatial_first=spatial_first, mode=SamplingMode.SAMPLE_EDGE)
